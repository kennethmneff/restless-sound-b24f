...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/restless-sound-b24f
```

A live public deployment of this template is available at [https://restless-sound-b24f.templates.workers.dev](https://restless-sound-b24f.templates.workers.dev)
